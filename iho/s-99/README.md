...
**IHO S-99** — GI registry operational procedures

IHO procedures for the geospatial information registry; placeholder crate for future automation or metadata types.

This repository targets **[Pelorus](https://sevenseas.io/pelorus) ECDIS / S-100** tooling. The **s-99** crate is an intentionally minimal **0.0.1** release to reserve the name on [crates.io](https://crates.io/crates/s-99) and align with hyphenated **S-xxx** naming. Semantic decoding may land in later versions.
