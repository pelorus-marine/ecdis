//! Bridges **Pelorus Core / Stream byte payloads** into [`pelorus_ecdis`] snapshot structs.
//!
//! This crate intentionally excludes sockets, CAN FD, NMEA, and DBC — those live in ship/services
//! crates that depend on Core schema releases. Here you get **timestamps**, **fusion helpers**, and
//! mapper traits implementors can wire to DCID layouts.

#![forbid(unsafe_code)]

use std::time::{Duration, Instant};

pub use pelorus_ecdis::{AisVesselReport, OwnShip};
