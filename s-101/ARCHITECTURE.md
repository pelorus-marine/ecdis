...
- **Out of scope:** **Portrayal Lua** execution (see [`ecdis-portrayal`](../ecdis-portrayal/)); **FAFF** / permits; **Pelorus Core transports** — use [`pelorus-ecdis`](../pelorus-ecdis/) for snapshots and [`pelorus-core-adapter`](../pelorus-core-adapter/) for mapper/time scaffolding.
