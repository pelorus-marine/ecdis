...
**IHO S-61** — Raster Navigational Charts (RNC)

IHO **raster** chart product (pixels). Distinct from **S-101** vector ENC and the **S-100** vector family. Reserve/implementation crate.

This repository targets **[Pelorus](https://sevenseas.io/pelorus) ECDIS / S-100** tooling. The **s-61** crate is an intentionally minimal **0.0.1** release to reserve the name on [crates.io](https://crates.io/crates/s-61) and align with hyphenated **S-xxx** naming. Semantic decoding may land in later versions.
